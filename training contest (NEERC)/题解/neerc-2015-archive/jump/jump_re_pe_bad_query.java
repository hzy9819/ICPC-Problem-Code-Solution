 ...
 * This solution makes bad query with 10% probability.
 *
 * @author Roman Elizarov
 */
public class jump_re_pe_bad_query {
    public static final long SEED = 20152411;
    public static final int MAX_N = 1000;
    public static final boolean DEBUG_LOG = false;

    public static void main(String[] args) throws Exception {
        new jump_re_pe_bad_query().go();
    }
    ...
    private void interact(Scanner in, PrintWriter out) throws IOException {
        ...
        while (true) {
            ...
            if (rnd.nextInt(10) == 0)
                q = Arrays.copyOf(q, q.length + 1); // MAKE BAD QUERY
